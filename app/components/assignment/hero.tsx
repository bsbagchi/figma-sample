...
export function Hero() {
  return (
    <section
      id="home"
      className="relative flex w-full flex-col items-stretch gap-6 overflow-visible pl-2 py-12 md:gap-8 md:pl-8 md:py-16 lg:gap-10 xl:absolute xl:inset-x-0 xl:top-[88px] xl:min-h-[1134px] xl:gap-0 xl:px-0 xl:py-0"
    >

...
export function Hero() {
  return (
    <section
      id="home"
      className="relative flex w-full flex-col items-stretch gap-10 overflow-visible py-12 md:gap-12 md:py-16 lg:gap-14 xl:absolute xl:inset-x-0 xl:top-[88px] xl:min-h-[1190px] xl:gap-0 xl:py-0"
    >
      ...
      <ProfileCluster className="relative z-[2] mt-2 shrink-0 md:mt-4 xl:absolute xl:inset-x-0 xl:top-[852px] xl:mt-0 xl:w-full" />
    </section>
  );
}

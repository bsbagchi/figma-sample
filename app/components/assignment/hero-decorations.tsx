...
function LeftVectors() {
  return (
    <div className="absolute top-28 left-0 z-[1] hidden h-[236px] w-14 md:block md:top-[400px] md:h-[304px] md:w-[72px] lg:top-[514.5px] lg:h-[355px] lg:w-[84px] 2xl:-left-40">
      <Vector2511
        stroke="#0e0e0e"
